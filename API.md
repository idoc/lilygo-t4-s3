...
This is a lightly-updated version of Espressif's generic BSP API doc. I mostly just updated it to reflect the board name and capabilities. 

<div align="center">

| :1234: [CAPABILITIES](#1234-capabilities) | :floppy_disk: [SD CARD AND SPIFFS](#floppy_disk-sd-card-and-spiffs) | :radio_button: [BUTTONS](#radio_button-buttons) | 
| :-------------------------: | :-------------------------: | :-------------------------: |
...
| Type | Name                                                           |
| ---: |:---------------------------------------------------------------|
| define  | [**BSP\_BOARD\_LILYGO_T4_S3**](#define-bsp_board_m5dial)  <br> |
